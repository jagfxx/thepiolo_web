...
export const es: Dictionary = {
  ...
  work: {
    ...
    description:
      "Sitios reales que generan confianza, captan clientes y representan cada negocio de forma profesional.",
    ...
    projects: [
      ...
      },
      {
        ...
        title: "Rosleben",
        subtitle:
          "Marca de cuidado capilar — landing de conversión para el Dúo Shampoo y Acondicionador con fórmula natural de guanábana.",
        body: "Sitio enfocado en ventas con oferta del dúo, ingredientes, beneficios, testimonios y checkout por WhatsApp. Diseño femenino y premium alineado con la identidad de la marca.",
        tags: ["Landing page", "E-commerce", "Captación de clientes", "En producción", "Belleza"],
        features: [
          "Landing de producto con oferta del dúo y precio promocional visible",
          "Secciones de beneficios, ingredientes, cómo usar y FAQ",
          "Testimonios y badges de confianza (sin sulfatos, cruelty-free)",
          "Checkout directo por WhatsApp integrado",
          "Diseño responsive optimizado para conversión en móvil",
        ],
        stack: ["Next.js 15", "Framer Motion", "Tailwind CSS", "TypeScript"],
        visitSiteAria: "Abrir el sitio de Rosleben en una nueva pestaña",
        visitInstagramAria: "Abrir el Instagram de Rosleben en una nueva pestaña",
      },
    ],
  },
  process: {
